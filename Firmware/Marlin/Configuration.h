...
#define STRING_CONFIG_H_AUTHOR "Version 1.0.0" // Who made the changes.
...
// TODO
// #define NOZZLE_BED_LEVELING
#define OLED
//#define NOZZLE_MOTOR
#define LED_STRIP

#define FILAMENT_UNLOAD_LEN         750  
#define FILAMENT_LOAD_LEN           650 
#define FILAMENT_UNLOAD_SPEED       200
...
#define DELTA_DIAGONAL_ROD 213.8 // mm
...
// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 190.2 // mm

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 27.9 // mm
...
//  #define DELTA_PROBABLE_RADIUS (DELTA_PRINTABLE_RADIUS + 4)
  ...
  #define FRONT_PROBE_BED_POSITION -(DELTA_PROBABLE_RADIUS -OFFSET)
...
// JB ??
#define DEFAULT_MAX_FEEDRATE          {500, 500, 500, 300}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {9000,9000,9000,9000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
...
//  #define NEWPANEL  //enable this if you have a click-encoder panel
  ...
  #define ULTRA_LCD
    ...
    #define LCD_HEIGHT 5
  #else
    #define LCD_WIDTH 20  // right here..
    #define LCD_HEIGHT 4
  #endif
