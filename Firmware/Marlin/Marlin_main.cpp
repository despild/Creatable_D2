...
#ifdef NOZZLE_MOTOR
// TODO
//  setup_stepper();// stepper for nozzle
#endif
  
  lcd_init();

#ifdef LED_STRIP  
  set_led_strip_color(255,255,255); // r, g, b
#endif
...
#ifdef LED_STRIP
        for (int i = 0; i < 255; i++) {
            set_led_strip_color(255,0,0); // 
            delay(50);

            set_led_strip_color(0,0,255); // 
            delay(50);
        }
#endif  
    ...
    case 29: // G29 Detailed Z-Probe, probes the bed at 3 or more points.
        {
            ...
            st_synchronize();	// wait until processing the buffered data.
            ...
            float xGap,yGap;
            yGap = (bed_level[1][2] - bed_level[1][0])/2;
            bed_level[1][1] = bed_level[1][0] + yGap;
            xGap = bed_level[1][1] - bed_level[0][1];
            bed_level[0][0] = bed_level[0][1] - yGap;
            bed_level[2][0] = bed_level[1][0] + xGap;
            bed_level[0][2] = bed_level[0][1] + yGap;
            bed_level[2][1] = bed_level[1][1] + xGap;
            bed_level[2][2] = bed_level[2][1] + yGap;
